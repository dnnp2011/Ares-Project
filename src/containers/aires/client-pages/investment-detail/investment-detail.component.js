...
const Forgot = (props) => {
  ...
  const rows = [
    {id: 0, fromAddress: "My Address", toAddress: "Hogwarts", amount: 2, date: "2018/01/18", transactionStatus: "Complete"},
    {id: 1, fromAddress: "My Address", toAddress: "Hogwarts", amount: 1, date: "2018/06/20", transactionStatus: "Complete"},
    {id: 2,fromAddress: "My Address", toAddress: "Hogwarts", amount: 7, date: "2018/07/01", transactionStatus: "In Progress"},
  ];
