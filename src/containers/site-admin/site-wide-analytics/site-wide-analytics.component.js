...
import styles from "./site-wide-analytics.theme.style";

const SiteWideAnalytics = (props) => {
  const { classes } = props;
...
SiteWideAnalytics.propTypes = {
  classes: PropTypes.shape({}).isRequired
};

export default withStyles(styles, { withTheme: true })(SiteWideAnalytics);
