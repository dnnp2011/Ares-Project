...
import styles from "./user-dashboard.style";
        ...
        <Grid item xs={12}>
          <Grid container justify="center" spacing={16}>
            <Grid key={1} item xs={12} sm={6} md={3} lg={3} xl={3} className={classes.portalWidget}>
              <Button variant='raised' className={[classes.portalWidgetContent, classes.button1]} component={Link}
                      to="/dashboard/crypto-market">
                Recent Investments
              </Button>
            </Grid>
            ...
            <Grid key={2} item xs={12} sm={6} md={3} className={classes.portalWidget}>
              ...
              <Button variant='raised' className={[classes.portalWidgetContent, classes.button2]} component={Link}
                      to="/dashboard/crypto-market">
                Portfolio
              </Button>
            </Grid>
            ...
            <Grid key={3} item xs={12} sm={6} md={3} className={classes.portalWidget}>
              ...
              <Button variant='raised' className={classes.portalWidgetContent} component={Link}
                      to="/dashboard/crypto-market">
