...
// CUSTOM AIRES ROUTES
const AsyncLaunchICO = asyncComponent(() => import('./containers/ico-admin/launch-ico/launchICO.component'));
const AsyncCollectKYC = asyncComponent(() => import('./containers/investor-kyc/collect-kyc/collectKYC.component'));
